...
namespace Hmxs.Toolkit.Flow.Timer
{
    public static class TimerExtension
    {
        ...
        public static Timer AttachTimer(this MonoBehaviour behaviour,string timerID, float duration, Action onComplete,
            Action<float> onUpdate = null, bool isLooped = false, bool useRealTime = false)
        {
            return Timer.Register(duration, onComplete, onUpdate, behaviour, isLooped: isLooped, useRealTime: useRealTime, timerID: timerID);
        }
